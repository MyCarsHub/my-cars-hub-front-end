...
@Component({
  ...
  // página. Em `/politica-de-privacidade?lang=en` a hidratação teria de trocar esse bloco
  // e falharia (erro no Sentry + flash de PT antes do EN). `ngSkipHydration` faz o Angular
  // descartar e re-renderizar a subárvore no cliente: o crawler continua recebendo o HTML
  // PT completo (o valor do prerender) e o visitante EN recebe o conteúdo certo sem erro.
