 ...
 * `aggregateRating`/`review` (the testimonials on the landing are not verified customer
 * reviews), `sku`/`gtin` (plans have no such identifiers) and `contactPoint` (the support
...
const SOFTWARE_DESCRIPTION =
  'Plataforma de gestão para locadoras de veículos: cadastro de frota e motoristas, ' +
  'aluguéis e contratos, cobranças automáticas, multas, manutenções e relatórios.';
